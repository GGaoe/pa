...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhu  , R, uint64_t tmp=(uint64_t)(uint32_t)src1*(uint64_t)(uint32_t)src2;R(rd)=(tmp>>32));
  ...
  INSTPAT("??????? ????? ????? 000 ????? 11001 11", jalr   , I, R(rd)=s->pc+4;s->dnpc=((src1+imm)));//wrong!
